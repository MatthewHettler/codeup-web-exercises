...
// geocode("The White House", mapboxToken).then(function(result){ console.log(result)
//     // recenter the map
//     // add a marker
...
reverseGeocode({lng: -98.4861, lat: 29.4260}, mapboxToken).then(function (result) { console.log(result) });
